...
public class FavProductAdapter extends RecyclerView.Adapter<FavProductAdapter.MyviewHolder> {
    ...
    public FavProductAdapter(Context context, List<GetAllProductsPojo> categoty) {
    ...
    public MyviewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.adapter_fav_product, parent, false);
