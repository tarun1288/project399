...
public class AdvancedSearchAdapter extends RecyclerView.Adapter<AdvancedSearchAdapter.MyviewHolder> {
    ...
    public AdvancedSearchAdapter(Context context, List<GetAllProductsPojo> sproduct) {
        this.a1=sproduct;
    ...
    public MyviewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.adapter_advanced_search, parent, false);
