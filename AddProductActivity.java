...
public class AddProductActivity extends AppCompatActivity implements EasyPermissions.PermissionCallbacks{
    EditText et_product_name = findViewById(R.id.et_product_name),et_price = (EditText)findViewById(R.id.et_price),et_description,et_quantity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sp_product_cat= findViewById(R.id.sp_product_cat);

        btn_product_img= findViewById(R.id.btn_product_img);
        btn_add_product= findViewById(R.id.btn_add_product);

        btn_product_img.setOnClickListener(this::onClick);
